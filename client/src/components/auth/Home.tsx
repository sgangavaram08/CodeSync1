                ...
                <div className="relative z-10 flex min-h-screen items-center justify-center bg-transparent text-white">
                    <div className="px-4 text-center md:px-12">
                        ...
                        <div className="flex justify-center space-x-4">
                            ...
                            <Link to="/loginpage"><a
                                href="#login"
                                className="inline-block rounded-lg bg-green-500 px-6 py-3 font-semibold text-black transition-all duration-300 hover:bg-green-600"
                            >
                                Login
                            </a></Link>
                            ...
                            <Link to="/register">
                                <a
                                    href="#register"
                                    className="inline-block rounded-lg border-2 border-green-500 px-6 py-3 font-semibold text-green-500 transition-all duration-300 hover:bg-green-500 hover:text-black"
                                >
                                    Register
                                </a>
                            </Link>
