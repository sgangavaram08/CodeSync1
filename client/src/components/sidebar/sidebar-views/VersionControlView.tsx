...
import { LuGitBranch, LuHistory, LuGitBranchPlus } from "react-icons/lu"
...
function VersionControlView() {
    ...
    const files: { id?: string; name?: string }[] = fileSystem?.files || []
    ...
    useEffect(() => {
        const mockChangedFiles = files.slice(0, 3).map((file: { id?: string; name?: string }) => ({
                                ...
                                <li key={commit.id} className="border-l-2 border-primary pl-4">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex items-center rounded-full bg-darkHover px-2 py-1 text-xs">
                                            <TbGitCommit size={12} className="mr-1" />
                                            {commit.id}
                                        </div>
                                    </div>
